...
export function MyDayShiftSummary() {
  const { user } = useAuth();
      ...
      <CardContent className="space-y-3">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              <Label className="text-xs text-muted-foreground mb-1 block">Calls</Label>
              <Input
                type="number"
                min="0"
                value={calls}
            ...
            <div>
              <Label className="text-xs text-muted-foreground mb-1 block">Texts</Label>
              <Input
                type="number"
                min="0"
                value={texts}
            ...
            <div>
              <Label className="text-xs text-muted-foreground mb-1 block">DMs</Label>
              <Input
                type="number"
                min="0"
                value={dms}
