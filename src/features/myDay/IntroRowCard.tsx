...
function getQBadge(status: UpcomingIntroItem['questionnaireStatus']) {
  switch (status) {
    case 'Q_COMPLETED':
      return <Badge variant="outline" className="border-green-500 text-green-700 dark:text-green-400 text-[10px] px-1.5 py-0 h-4">Complete</Badge>;
    case 'Q_SENT':
      return <Badge variant="outline" className="border-yellow-500 text-yellow-700 dark:text-yellow-400 text-[10px] px-1.5 py-0 h-4">Not answered</Badge>;
    case 'NO_Q':
      return <Badge variant="outline" className="border-destructive text-destructive text-[10px] px-1.5 py-0 h-4">Not sent</Badge>;
  }
}
  ...
  return (
    <div className="rounded-lg border bg-card overflow-hidden">
      <div className="p-3 space-y-2">
        {/* Row 1: Q badge + Name + other badges */}
