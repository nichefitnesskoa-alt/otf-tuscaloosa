/**
 * Pipeline filter bar: tabs and search.
 * Exact same tab structure as original ClientJourneyPanel.
 */
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button
          ...
          size="sm"
          onClick={onToggleInconsistencies}
        >
      ...
      {/* Tabs */}
      <Tabs value={activeTab} onValueChange={(v) => onTabChange(v as JourneyTab)} className="w-full">
      ...
      {activeTab === 'by_lead_source' && (
        <Select
          ...
          onValueChange={(v) => onLeadSourceChange(v === 'all' ? null : v)}
        >
