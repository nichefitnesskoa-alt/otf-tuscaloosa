...
const STAGE_COLORS: Record<string, string> = {
  ...
  won: 'bg-warning text-primary-foreground',
          ...
          <ScrollArea className="px-4 pb-6 flex-1">
            ...
            {!isBooked && (
              <div className="grid grid-cols-3 gap-2 mb-4">
                ...
                {lead.stage !== 'won' && (
                  <Button size="sm" className="text-xs bg-warning hover:bg-warning text-primary-foreground" onClick={handleMarkPurchased} disabled={markingPurchased}>
