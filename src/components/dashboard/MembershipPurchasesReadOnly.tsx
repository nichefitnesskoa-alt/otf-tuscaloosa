      ...
      <CardContent>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4">
          <div className="bg-muted/50 p-2 rounded text-center">
            <p className="text-lg font-bold text-success">${stats.total.toFixed(0)}</p>
          ...
          <div className="bg-muted/50 p-2 rounded text-center hidden sm:block">
              ...
              <TableBody>
                {purchases.map(purchase => (
                  <TableRow key={purchase.id}>
                    ...
                    <TableCell>
                      <Badge variant={getMembershipBadgeVariant(purchase.membership_type)} className="text-xs">
                        {purchase.membership_type.replace(' w/o OTBeat', '').replace(' + OTBeat', '+')}
                      </Badge>
                    </TableCell>
                    <TableCell className="text-xs">
