    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label>Is this a former member winback sale? *</Label>
            <Select value={winbackChoice} onValueChange={(v) => setWinbackChoice(v as 'yes' | 'no')}>
              <SelectTrigger><SelectValue placeholder="Select…" /></SelectTrigger>
              <SelectContent>
                <SelectItem value="yes">Yes — winback (previously an OTF member or class-pack holder)</SelectItem>
                <SelectItem value="no">No — brand new to OTF</SelectItem>
              </SelectContent>
            </Select>
            <p className="text-xs text-muted-foreground mt-1">
              Winbacks count fully for commission and sales totals, but are excluded from close/show rate.
            </p>
          </div>
