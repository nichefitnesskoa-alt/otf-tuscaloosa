...
export default function StaffManagement() {
  ...
  const getRoleBadgeColor = (r: string) => {
    switch (r) {
      ...
      case 'Coach': return 'bg-success text-primary-foreground';
      case 'Both': return 'bg-neutral text-primary-foreground';
      ...
      <Card>
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" onClick={openAdd} className="gap-1 bg-brand hover:bg-brand-hover text-primary-foreground">
      ...
      <Dialog open={!!editingPermissions} onOpenChange={(o) => !o && setEditingPermissions(null)}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            ...
            <Button onClick={savePermissions} disabled={savingPerms} className="bg-brand hover:bg-brand-hover text-primary-foreground">
