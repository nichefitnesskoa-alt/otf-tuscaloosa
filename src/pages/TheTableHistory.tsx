    ...
    <div className="p-4 max-w-3xl mx-auto pb-24">
      ...
      {selected && detail?.meeting && (
        <>
          ...
          {detail.meeting.koa_open_note && <Card className="p-3 mb-3 border-2 border-brand/40 bg-brand/5"><div className="text-xs font-semibold uppercase mb-1 text-[#E8540A]">Studio Leader Open</div>{detail.meeting.koa_open_note}</Card>}
          ...
          {detail.close && (
            <Card className="p-3 mt-3 border-2 border-brand/40 bg-brand/5">
              <div className="text-xs font-semibold uppercase mb-1 text-[#E8540A]">Studio Leader Close</div>
