  ...
  const handleInstantBooking = async (index: number) => {
    ...
    try {
      ...
      const { data: insertedBooking, error: bookingInsertError } = await supabase.from('intros_booked').insert({
        ...
        booked_by: staffName,
        lead_source: booking.leadSource || 'Instagram DMs',
          ...
          if (linkedBookingId) {
            ...
            const { data: newBooking, error: bookingError } = await supabase
              ...
              .insert({
                ...
                lead_source: run.leadSource || 'Instagram DMs',
      ...
      for (const sale of sales) {
        if (sale.memberName && sale.membershipType) {
          ...
          await supabase.from('sales_outside_intro').insert({
            ...
            lead_source: sale.leadSource || 'Instagram DMs',
